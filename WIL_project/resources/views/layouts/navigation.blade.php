        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <!-- <img src="{{ asset('images/WIL_LOGO.png') }}" class="block h-11 w-auto" alt="WIL Logo"> -->
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @elseif (Auth::user()->user_type === 'expert')
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }} [{{ Auth::user()->user_code }}]</div>
                            <!-- add the user_code code next to name -->
